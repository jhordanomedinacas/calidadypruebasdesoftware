...
@Component({
  ...
  templateUrl: './todas.html',
  styleUrl: './todas.css'
})
export class TodasComponent implements OnInit, OnDestroy {
  ...
  private todasNoticias: Noticia[] = [
    {
      ...
      resumen:
        'La nueva extensión parte desde la intersección de la Av. Tacna con el Centro Cívico y llega hasta la intersección de Faucett con Quilca, en el Callao.',
  ...
  // ── Filtro + Paginación ────────────────────────────────────────────────────
  private aplicarFiltroYPaginar(): void {
